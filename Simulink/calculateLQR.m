...
B = [sin(theta_left)*len_origen_1  , sin(theta_right)*len_origen_2  , sin(theta_3)*len_origen_3;
     cos(theta_left+vector_angel_1), cos(theta_right+vector_angel_2), 0;
     sin(theta_left+vector_angel_1), sin(theta_right+vector_angel_2), 1]
