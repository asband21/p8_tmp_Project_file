function [x_hat] = kalman_filter_sim_l(time, olde_time, x_mes, x_hat_old)
...
for i = 2:N
    ...
    x_hat(:,i)  = kalman_filter_sim_l(time(i), time(i-1), x(:,i-1)+random('Normal',0,1), x_hat(:,i-1)); % Estes Medt state.
end
